...
class SetupProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loadDataUser()
        //navigationViewSetup.setOnNavigationItemSelectedListener(navigationListener)
    ...
    private val navigationListener = BottomNavigationView.OnNavigationItemSelectedListener { item ->
        when (item.itemId) {
            R.id.home -> {
                fragment_container_setup.visibility = View.GONE
                val intent = Intent(this, SetupProfileActivity::class.java)
                startActivity(intent)
                return@OnNavigationItemSelectedListener true
            }
            R.id.forum -> {
                supportFragmentManager.beginTransaction().replace(R.id.fragment_container, ForumFragment()).commit()
                fragment_container_setup.visibility = View.VISIBLE
                return@OnNavigationItemSelectedListener true
            }
            R.id.about_us -> {
                fragment_container_setup.visibility = View.VISIBLE
